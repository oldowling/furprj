                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Projects List</li>
                                    </ul>
                                </div>
                            ...
                            <div class="table-data__tool">
                                ...
                                <?php if($_SESSION['userinfo']['role']==1 || $_SESSION['userinfo']['role']==2) { ?>
                                    <div class="table-data__tool-right">
                                        <a href="new-project.php" class="au-btn au-btn-icon au-btn--green au-btn--small">
...
-->
                                            ...
                                            <td>{{p.language}}</td>
                                            <td>
                                                <span ng-if="p.status==1" class="work-stream">Approved</span>
                                                <span ng-if="p.status==2" class="work-stream">Review</span>
                                                <span ng-if="p.status==3" class="work-stream">Draft</span>
                                            </td>
                                            <td>
